        ...
        <div class="content">
            <div class="read">
                ...
                <div class="updown">
                    ...
                    <div>
                        <label for="0">
                            <img src="img/down_arrow.png" /><a href="/">Гипотеза о происхождении пятен на Солнце</a>
                            <span><span class="date">26.09.2015</span><span class="user">admin</span><span class="views">5</span></span>
                    ...
                    <div>
                        <label for="1">
                            <img src="img/down_arrow.png" /><a href="/">Изменяется ли светимость Солнца?</a><div style="margin-top: .7em; margin-right: .7em; font-size: .9em">
                    ...
                    <div>
                        <label for="2">
                            <img src="img/down_arrow.png" /><a href="/">Солнечная активность</a><div style="margin-top: .7em; margin-right: .7em; font-size: .9em">
                    ...
                    <div>
                        <label for="3">
                            <img src="img/down_arrow.png" /><a href="/">Солнечная активность и атмосфера Солнца</a><div style="margin-top: .7em; margin-right: .7em; font-size: .9em">
                                <div class="date">24.09.2015</div>
                                <div class="user">2314</div>
