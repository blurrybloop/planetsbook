<h1>Как редактировать статьи или комментарии?</h1>
<p>На нашем сайте поддерживается простой текст, а также некоторые возможности форматирования с помощью BB-кодов.</p>
...
<p>Если вы хотите узнать, как будет выглядеть ваша статья или комментарий после отправки, используйте кнопку "Предпросмотр". Вы всегда сможете вернуться в режим редактирования, если результат вас не устроит.</p>
